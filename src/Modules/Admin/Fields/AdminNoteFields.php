...
namespace atc\BhWP\Modules\Admin\Fields;
...
final class AdminNoteFields implements FieldGroupInterface
{
    public static function register(): void
    {
        ...
        FieldKeyMigrator::migrate([
            'field_624775f4b6221' => [
                'new_field_key' => 'field_bhwp_modulename_first_name',
                'old_meta_key'  => 'first_name',
                'new_meta_key'  => 'bhwp_modulename_first_name',
            ],
            'field_abc123xyz456' => [
                'new_field_key' => 'field_bhwp_notes',
                // no meta_key rename
            ],
        ]);
        */
