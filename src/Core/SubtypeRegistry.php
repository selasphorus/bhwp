...
final class SubtypeRegistry
{
    ...
    public static function collect(): void
    {
        ...
        // 1) Gather providers
        $providers = apply_filters('bhwp_register_subtypes', []);  // array of SubtypeInterface|class-string
         ...
         */
        //do_action('bhwp_subtypes_collected', self::$subtypes);
        do_action('bhwp_subtypes_collected', self::$meta, self::$instances);
    }
