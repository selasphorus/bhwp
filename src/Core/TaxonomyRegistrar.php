...
final class TaxonomyRegistrar
{
     ...
     * Accepts handlers via the 'bhwp_register_taxonomy_handlers' filter.
    ...
    public static function bootstrap(): void
    {
        ...
        $handlers = (array) apply_filters('bhwp_register_taxonomy_handlers', []);
        ...
        $activePostTypes = (array) apply_filters('bhwp_active_post_types', []);
