...
{
    private const OPTION = 'bhwp_plugin_settings';

    public function getOption(): array
    {
        $saved = get_option(self::OPTION, []);
        //$saved = get_option( 'bhwp_plugin_settings', [] );
        //
        $defaults = [
            'initialized'     => 0,
            'active_modules'     => [],
    ...
    public function ensureInitialized(array $availableModules): void //, array $allPostTypesByModule
    {
        ...
        $needsSeeding =
            ...
            //&& get_option('bhwp_initialized', 0) !== 1;
        ...
        //update_option('bhwp_initialized', 1);
    }
    ...
    public function getDefaultActiveModules(array $allModules): array
    {
        ...
        $defaultSlugs = apply_filters('bhwp_default_active_modules', $allModuleSlugs);
    ...
    protected function getDefaultActiveModules(): array
    {
        ...
        $defaults = apply_filters('bhwp_default_active_modules', $all);
        return $defaults;
    }
    */
